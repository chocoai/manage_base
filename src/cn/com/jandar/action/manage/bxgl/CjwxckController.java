...
@ControllerBind(controllerKey="/manage/bxgl/cjwxck",resource="厂家维修出库单")
public class CjwxckController extends AdminBaseController{
	...
	public void index() {
		...
		setAttr("page", page);
		render("cjwxck_list.html");
	}

	@ButtonBind(buttonname = "新增")
	public void add() {

		render("cjwxck_input.html");
	}
	...
	public void save() {
		...
		if (msg.equals(Produce.SUCCESS)) {
			...
			setAttr("redirectionUrl", "/manage/bxgl/cjwxck");
	...
	public void printchuku(){     
		...
		String report_fileName="厂商维修出库单";
